<x-layout>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6">
                <img src="/img/dea.png" alt="" class="w-75">
            </div>
        </div>
    </div>
    <!--Waves Container-->
    <div>
        ...
        <g class="parallax">
            <use xlink:href="#gentle-wave" x="48" y="0" fill="#97d1de" />
            <use xlink:href="#gentle-wave" x="48" y="3" fill="#ffffff" />
            <use xlink:href="#gentle-wave" x="48" y="7" fill="#1980aa" />
            <use xlink:href="#gentle-wave" x="48" y="5" fill="#c7ab57" />
        </g>
        </svg>
        </div>
        <!--Waves end-->
    <div class="container margin-custom container-icon">
        <div class="row align-items-center h-100">
            <div class="col-12 col-md-4 d-flex justify-content-center align-items-center flex-column">
                <i class="fa-solid fa-ranking-star fa-2xl" style="color: #1980aa;"></i>
                <p class="my-4">Qualità</p>
            </div>
            <div class="col-12 col-md-4 d-flex justify-content-center align-items-center flex-column">
                <i class="fa-solid fa-check fa-2xl" style="color: #1980aa;"></i>
                <p class="my-4">Controlli continui</p>
            </div>
            <div class="col-12 col-md-4 d-flex justify-content-center align-items-center flex-column">
                <i class="fa-solid fa-handshake-angle fa-2xl" style="color: #1980aa;"></i>
                <p class="my-4">Supporto clienti</p>
            </div>
        </div>
    </div>
